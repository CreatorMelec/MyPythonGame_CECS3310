# MyPythonGame_CECS3310

My name is Elimelec Rodriguez and this is my project that consists of a simple memory gaming using the library "graphics". 
It uses simple shapes drawn on screen and then asks the player what shape was in one of the 4 squares, which are carefully labled as 1,2,3 and 4. 
